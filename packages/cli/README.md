...
```bash
bunx @doubleprecision/solidui-cli@latest init
```
...
```bash
bunx @doubleprecision/solidui-cli@latest add [component]
```

### Example

```bash
bunx @doubleprecision/solidui-cli@latest add alert-dialog
```

You can also run the command without any arguments to view a list of all available components:

```bash
bunx @doubleprecision/solidui-cli@latest add
```
