...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-(--kb-toast-swipe-end-x) data-[swipe=move]:translate-x-(--kb-toast-swipe-move-x) data-[swipe=move]:transition-none ui-opened:animate-in ui-closed:animate-out data-[swipe=end]:animate-out ui-closed:fade-out-80 ui-closed:slide-out-to-right-full ui-opened:slide-in-from-top-full sm:ui-opened:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
