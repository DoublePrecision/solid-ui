...
const ComboboxItem = <T extends ValidComponent = "li">(
  ...
  return (
    <ComboboxPrimitive.Item
      class={cn(
        "relative flex cursor-default select-none items-center justify-between rounded-sm px-2 py-1.5 text-sm outline-hidden ui-disabled:pointer-events-none ui-highlighted:bg-accent ui-highlighted:text-accent-foreground ui-disabled:opacity-50",
        local.class
      )}
      {...others}
    />
