...
const TabsTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <TabsPrimitive.Trigger
      class={cn(
        "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ui-selected:bg-background ui-selected:text-foreground ui-selected:shadow-xs",
        local.class
      )}
      {...others}
    />
